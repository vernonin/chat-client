			...
			<div  className="bg-gray-50 rounded-lg scale-in-center">
				<div className="flex flex-col max-w-md gap-2 p-6 rounded-md shadow-md dark:bg-gray-900 dark:text-gray-100">
					...
					<div className="flex flex-col justify-end gap-3 mt-6 sm:flex-row">
						<button className="px-6 py-2 rounded-lg border border-current" onClick={onCancel}>取 消</button>
						<button className="px-6 py-2 rounded-lg text-white shadow-sm bg-red-600" onClick={onConfirm}>确 定</button>
					</div>
				</div>
			</div>
		</div>
