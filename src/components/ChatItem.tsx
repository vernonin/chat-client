...
const LeftChat: FC<LeftChatProps> = ({
	...
	return (
		<div ref={isLastEle ? lastEleRef : null} className={`d-flex mt-2 chat-item ${role === 'user' ? 'flex-row-reverse' : ''}`}>
			<img style={style} className='rounded' src={role === 'user' ? '/user.png' : '/gpt.png'} />
